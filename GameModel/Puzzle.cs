...
namespace RoboZZle.GameModel
{
	public class Puzzle
	{
		...
		public ProgramExecutionResult TrySolveWith(Program program, out int starsEaten)
		{
			...
			return CanBeSolvedWithDfs(stateSet, eatenStarsMask, ref state, ref starsEaten, program);
		}

		public bool CanBeSolvedWith(Program program)
		{
			int starsEaten;
			return this.TrySolveWith(program, out starsEaten) == ProgramExecutionResult.StarsEaten;
		}
